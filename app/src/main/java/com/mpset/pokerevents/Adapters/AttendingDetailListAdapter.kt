...
class AttendingDetailListAdapter(val context:Context?, val userList: ArrayList<ArchiveDetailsHostModel>, var myClickListener: MyClickListener) : RecyclerView.Adapter<AttendingDetailListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val v = LayoutInflater.from(p0.context).inflate(R.layout.snipped_attending_detail, p0, false)
        return ViewHolder(v)
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val txtName = itemView.findViewById(R.id.attending_detail_host_name) as TextView
        val txtNickname = itemView.findViewById(R.id.attending_detail_host_nickname) as TextView
